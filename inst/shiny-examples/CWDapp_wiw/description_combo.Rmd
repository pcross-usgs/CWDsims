...
This application uses the "who-infects-who" transmission models that allows for different male-to-female, female-to-male and male-to-male transmission rates.  
...
|                | male to female transmission  | $\beta_{mf}$ | beta.mf |$\beta_{mf} = \beta_{ff}\gamma_{mf}$ |
|                | female to male transmission  | $\beta_{fm}$ | beta.fm |$\beta_{fm} = \beta_{ff}\gamma_{fm}$  |
|                | male to male transmission  | $\beta_{mm}$ | beta.fm | $\beta_{mm} = \beta_{ff}\gamma_{mm}$  |
|                | scaling parameters  | $\gamma_{ij}$ | gamma.mf, gamma.fm, gamma.mm | |
...
There is a separate transmission rate within males, within females, from males to females, and from females to males. Here "wiw" is short for who-infects-who. The infection probability then for females is: 
