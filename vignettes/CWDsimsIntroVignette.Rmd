...
For details on how the CWD models are structured see XXXX.

For an overview of the parameters used in the model see XXX.

For a description of the plotting functions see XXX.
