...
## ----outsummary, echo = TRUE, eval = TRUE-----------------
summary(out)
head(out$counts)
head(out$deaths)
unique(out$deaths$category)

## ----plotting, echo = TRUE, eval = TRUE-------------------
...
## ----stochwrapper, echo = TRUE, eval = TRUE---------------
...
## ----compare-det, echo = TRUE, eval = TRUE----------------
...
## ----compare-stoch, echo = TRUE, eval = TRUE--------------
