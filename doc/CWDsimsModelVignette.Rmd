...
The models assume that males may be more likely to become infected than females. In the model functions $\beta_f$ and $\beta_m$ are independent parameters. However, in the shiny app the user inputs $\gamma$, whereby $\beta_m = \beta_f\gamma$ and if females and males are equally likely to become infected then $\gamma=1$.
